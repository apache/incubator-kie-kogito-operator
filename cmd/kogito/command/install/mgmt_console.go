...
func (i *installMgmtConsoleCommand) InitHook() {
	...
	i.command.Flags().StringVarP(&i.flags.image, "image", "i", infrastructure.DefaultMgmtConsoleImageFullTag, "Image tag for the Management Console, example: quay.io/kiegroup/kogito-management-service:latest")
}
