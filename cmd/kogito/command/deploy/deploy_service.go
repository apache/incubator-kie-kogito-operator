...
func (i *deployCommand) InitHook() {
	...
	i.command.Flags().StringVar(&i.flags.projectGroupId, "project-group-id", "com.company", "Indicates the unique identifier of the organization or group that created the project.")
	i.command.Flags().StringVar(&i.flags.projectArtifactId, "project-artifact-id", "project", "Indicates the unique base name of the primary artifact being generated.")
	i.command.Flags().StringVar(&i.flags.projectVersion, "project-version", "1.0-SNAPSHOT", "Indicates the version of the artifact generated by the project.")
}
