...
func (i *deployCommand) InitHook() {
	...
	i.command.Flags().BoolVar(&i.flags.enableMavenDownloadOutput, "maven-output", false, "If set to true will print the logs for downloading/uploading of maven dependencies. Defaults to false")
}
