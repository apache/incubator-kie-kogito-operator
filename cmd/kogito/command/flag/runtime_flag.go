...
func AddRuntimeFlags(command *cobra.Command, flags *RuntimeFlags) {
	...
	command.Flags().BoolVar(&flags.EnableGrafana, "enable-grafana", false, "If set to true, deployed Kogito service will support integration with Grafana for monitoring. Default to false")
