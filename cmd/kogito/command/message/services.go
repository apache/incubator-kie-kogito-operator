...
const (
	...
	// ServicePrometheusNotAvailable ...
	ServicePrometheusNotAvailable = "Prometheus is not available in the Project: %s. Please make sure to install the Prometheus Operator before deploying the service without Prometheus provided "
	// ServiceGrafanaNotAvailable ...
	ServiceGrafanaNotAvailable = "Grafana is not available in the Project: %s. Please make sure to install the Grafana Operator before deploying the service without Grafana provided "
)
