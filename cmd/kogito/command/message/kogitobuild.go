...
var (
	...
	KogitoViewBuildStatus = "Your Kogito Runtime Service should be deploying. To see its logs, run 'oc logs -f bc/%s-builder -n %s'"
	// KogitoBuildSuccessfullyUploadedFile ...
	KogitoBuildSuccessfullyUploadedFile = "The requested file(s) was successfully uploaded to OpenShift, a build with this file(s) should now be running. To see the logs, run 'oc logs -f bc/%s-builder -n %s'"
