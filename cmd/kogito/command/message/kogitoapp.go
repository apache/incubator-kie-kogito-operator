...
const (
	...
	KogitoAppViewBuildStatus           = "Your Kogito service should be deploying. To see its logs, run 'oc logs -f bc/%s-builder -n %s'"
	KogitoAppUploadBinariesInstruction = "Your Kogito service needs the application binaries to proceed. To upload your binaries please run 'oc start-build %s-binary --from-dir=target -n %s' from your project's root"
	KogitoAppNoMgmtConsole             = `To more easily manage your Kogito service install Data Index Service and Process Instance Management. 
