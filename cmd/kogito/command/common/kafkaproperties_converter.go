...
// FromKafkaFlagsToKafkaProperties converts given KafkaFlags into KafkaConnectionProperties
func FromKafkaFlagsToKafkaProperties(kafkaFlags *KafkaFlags, enableEvents bool) v1alpha1.KafkaConnectionProperties {
...
func initializeUserDefineKafkaProperties(kafkaProperties *v1alpha1.KafkaConnectionProperties, kafkaFlags *KafkaFlags) {
	log := context.GetDefaultLogger()
