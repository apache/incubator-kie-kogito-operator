...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.Builds":                        schema_pkg_apis_app_v1beta1_Builds(ref),
		"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.Condition":                     schema_pkg_apis_app_v1beta1_Condition(ref),
		"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.GitSource":                     schema_pkg_apis_app_v1beta1_GitSource(ref),
		"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoBuild":                   schema_pkg_apis_app_v1beta1_KogitoBuild(ref),
		"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoBuildStatus":             schema_pkg_apis_app_v1beta1_KogitoBuildStatus(ref),
		...
		"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoSupportingServiceStatus": schema_pkg_apis_app_v1beta1_KogitoSupportingServiceStatus(ref),
		"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.WebHookSecret":                 schema_pkg_apis_app_v1beta1_WebHookSecret(ref),
	}
}

func schema_pkg_apis_app_v1beta1_Builds(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_app_v1beta1_Condition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_app_v1beta1_GitSource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_app_v1beta1_KogitoBuild(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoBuildSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoBuildStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoBuildSpec", "github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoBuildStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_app_v1beta1_KogitoBuildStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoBuildConditions"),
									},
								},
							},
						},
					...
					"builds": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.Builds"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.Builds", "github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoBuildConditions"},
	}
}

func schema_pkg_apis_app_v1beta1_KogitoInfra(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoInfraSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoInfraStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoInfraSpec", "github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoInfraStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_app_v1beta1_KogitoInfraSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.Resource"},
	}
}

func schema_pkg_apis_app_v1beta1_KogitoInfraStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"condition": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoInfraCondition"),
						},
					},
					"appProps": {
						SchemaProps: spec.SchemaProps{
					...
					"volumes": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoInfraVolume"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoInfraCondition", "github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoInfraVolume", "k8s.io/api/core/v1.EnvVar"},
	}
}
...
func schema_pkg_apis_app_v1beta1_KogitoRuntime(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoRuntimeSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoRuntimeStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoRuntimeSpec", "github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoRuntimeStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_app_v1beta1_KogitoSupportingService(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoSupportingServiceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoSupportingServiceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoSupportingServiceSpec", "github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoSupportingServiceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_app_v1beta1_KogitoSupportingServiceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"monitoring": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.Monitoring"),
						},
					},
					"config": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_app_v1beta1_KogitoSupportingServiceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.Condition"),
									},
								},
							},
						},
					...
					"cloudEvents": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoCloudEventsStatus"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.Condition", "github.com/kiegroup/kogito-cloud-operator/pkg/apis/app/v1beta1.KogitoCloudEventsStatus", "k8s.io/api/apps/v1.DeploymentCondition"},
	}
}

func schema_pkg_apis_app_v1beta1_WebHookSecret(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
