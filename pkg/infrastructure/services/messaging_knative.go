...
func (k *knativeMessagingDeployer) newTrigger(t messageTopic, service v1beta1.KogitoService, infra *v1beta1.KogitoInfra) *eventingv1.Trigger {
...
func (k *knativeMessagingDeployer) triggerExists(t messageTopic, service v1beta1.KogitoService) (bool, error) {
