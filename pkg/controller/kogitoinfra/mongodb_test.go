...
func TestRetrieveMongoDBCredentialsFromInstance(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			objects = append(objects, mongoDBInstance)
			...
			cli := test.CreateFakeClient(objects, nil, nil)
			...
			creds, err := retrieveMongoDBCredentialsFromInstance(cli, kogitoInfra, mongoDBInstance)
