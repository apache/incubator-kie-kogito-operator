...
import (
	...
	appv1alpha1 "github.com/kiegroup/submarine-cloud-operator/pkg/apis/app/v1alpha1"
...
var log = logf.Log.WithName("controller_subapp")
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.SubApp{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileSubApp) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling SubApp")

	// Fetch the SubApp instance
	instance := &appv1alpha1.SubApp{}
...
func newPodForCR(cr *appv1alpha1.SubApp) *corev1.Pod {
