...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSKeyStore) DeepCopyInto(out *TLSKeyStore) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSKeyStore.
func (in *TLSKeyStore) DeepCopy() *TLSKeyStore {
	if in == nil {
		return nil
	}
	out := new(TLSKeyStore)
