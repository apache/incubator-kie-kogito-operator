...
openapi-gen --logtostderr=true -v 1 -o "" -i github.com/kiegroup/community-kogito-operator/api/v1beta1 -O zz_generated.openapi -p ./api/v1beta1 -h ./hack/boilerplate.go.txt -r "-"