...
func BindFlags(set *flag.FlagSet) {
	...
	set.StringVar(&env.mgmtConsoleImageTag, prefix+"management-console-image-tag", "", "Set the Kogito Trusty UI image tag ('services-image-version' is ignored)")
	set.StringVar(&env.trustyUIImageTag, prefix+"trusty-ui-image-tag", "", "Set the Kogito Management Console image tag ('services-image-version' is ignored)")
