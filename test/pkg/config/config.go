...
type TestConfig struct {
	...
	quarkus_platform_maven_mirror_url  string
...
func BindFlags(set *flag.FlagSet) {
	...
	set.StringVar(&env.quarkusPlatformMavenMirrorURL, prefix+"quarkus_platform_maven_mirror_url", "", "Maven mirror url to be used when building app from source files with Quarkus, using the quarkus maven plugin.")
...
func GetQuarkusPlatformMavenMirrorURL() string {
	return env.quarkus_platform_maven_mirror_url
}
