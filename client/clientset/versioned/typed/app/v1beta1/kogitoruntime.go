...
// KogitoRuntimesGetter has a method to return a KogitoRuntimeInterface.
...
// kogitoRuntimes implements KogitoRuntimeInterface
type kogitoRuntimes struct {
...
func (c *kogitoRuntimes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.KogitoRuntime, err error) {
	result = &v1beta1.KogitoRuntime{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kogitoruntimes").
		Name(name).
...
func (c *kogitoRuntimes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.KogitoRuntimeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.KogitoRuntimeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kogitoruntimes").
...
func (c *kogitoRuntimes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kogitoRuntimes) Create(ctx context.Context, kogitoRuntime *v1beta1.KogitoRuntime, opts v1.CreateOptions) (result *v1beta1.KogitoRuntime, err error) {
	result = &v1beta1.KogitoRuntime{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kogitoruntimes").
...
func (c *kogitoRuntimes) Update(ctx context.Context, kogitoRuntime *v1beta1.KogitoRuntime, opts v1.UpdateOptions) (result *v1beta1.KogitoRuntime, err error) {
	result = &v1beta1.KogitoRuntime{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kogitoruntimes").
...
func (c *kogitoRuntimes) UpdateStatus(ctx context.Context, kogitoRuntime *v1beta1.KogitoRuntime, opts v1.UpdateOptions) (result *v1beta1.KogitoRuntime, err error) {
	result = &v1beta1.KogitoRuntime{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kogitoruntimes").
...
func (c *kogitoRuntimes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kogitoRuntimes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kogitoRuntimes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.KogitoRuntime, err error) {
	result = &v1beta1.KogitoRuntime{}
