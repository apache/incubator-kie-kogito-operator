...
func (c *FakeKogitoInfras) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.KogitoInfra, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(kogitoinfrasResource, c.ns, name), &v1beta1.KogitoInfra{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.KogitoInfra), err
}
...
func (c *FakeKogitoInfras) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.KogitoInfraList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(kogitoinfrasResource, kogitoinfrasKind, c.ns, opts), &v1beta1.KogitoInfraList{})
	...
	list := &v1beta1.KogitoInfraList{ListMeta: obj.(*v1beta1.KogitoInfraList).ListMeta}
	for _, item := range obj.(*v1beta1.KogitoInfraList).Items {
...
func (c *FakeKogitoInfras) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(kogitoinfrasResource, c.ns, opts))
...
func (c *FakeKogitoInfras) Create(ctx context.Context, kogitoInfra *v1beta1.KogitoInfra, opts v1.CreateOptions) (result *v1beta1.KogitoInfra, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(kogitoinfrasResource, c.ns, kogitoInfra), &v1beta1.KogitoInfra{})
...
func (c *FakeKogitoInfras) Update(ctx context.Context, kogitoInfra *v1beta1.KogitoInfra, opts v1.UpdateOptions) (result *v1beta1.KogitoInfra, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(kogitoinfrasResource, c.ns, kogitoInfra), &v1beta1.KogitoInfra{})
...
func (c *FakeKogitoInfras) UpdateStatus(ctx context.Context, kogitoInfra *v1beta1.KogitoInfra, opts v1.UpdateOptions) (*v1beta1.KogitoInfra, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(kogitoinfrasResource, "status", c.ns, kogitoInfra), &v1beta1.KogitoInfra{})
...
func (c *FakeKogitoInfras) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(kogitoinfrasResource, c.ns, name), &v1beta1.KogitoInfra{})
...
func (c *FakeKogitoInfras) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(kogitoinfrasResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.KogitoInfraList{})
	return err
}
...
func (c *FakeKogitoInfras) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.KogitoInfra, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(kogitoinfrasResource, c.ns, name, pt, data, subresources...), &v1beta1.KogitoInfra{})
