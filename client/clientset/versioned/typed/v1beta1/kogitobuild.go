...
// KogitoBuildsGetter has a method to return a KogitoBuildInterface.
...
// kogitoBuilds implements KogitoBuildInterface
type kogitoBuilds struct {
	client rest.Interface
	ns     string
}

// newKogitoBuilds returns a KogitoBuilds
func newKogitoBuilds(c *AppV1beta1Client, namespace string) *kogitoBuilds {
	return &kogitoBuilds{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *kogitoBuilds) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.KogitoBuild, err error) {
	result = &v1beta1.KogitoBuild{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kogitobuilds").
		Name(name).
...
func (c *kogitoBuilds) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.KogitoBuildList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.KogitoBuildList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kogitobuilds").
...
func (c *kogitoBuilds) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kogitoBuilds) Create(ctx context.Context, kogitoBuild *v1beta1.KogitoBuild, opts v1.CreateOptions) (result *v1beta1.KogitoBuild, err error) {
	result = &v1beta1.KogitoBuild{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kogitobuilds").
...
func (c *kogitoBuilds) Update(ctx context.Context, kogitoBuild *v1beta1.KogitoBuild, opts v1.UpdateOptions) (result *v1beta1.KogitoBuild, err error) {
	result = &v1beta1.KogitoBuild{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kogitobuilds").
		Name(kogitoBuild.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(kogitoBuild).
		Do(ctx).
		Into(result)
...
func (c *kogitoBuilds) UpdateStatus(ctx context.Context, kogitoBuild *v1beta1.KogitoBuild, opts v1.UpdateOptions) (result *v1beta1.KogitoBuild, err error) {
	result = &v1beta1.KogitoBuild{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kogitobuilds").
...
func (c *kogitoBuilds) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kogitoBuilds) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kogitoBuilds) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.KogitoBuild, err error) {
	result = &v1beta1.KogitoBuild{}
