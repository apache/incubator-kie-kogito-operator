...
import (
	...
	v1beta1 "github.com/kiegroup/kogito-operator/client/informers/internalversion/v1beta1"
...
type SharedInformerFactory interface {
	...
	App() v1beta1.Interface
}

func (f *sharedInformerFactory) App() v1beta1.Interface {
	return v1beta1.New(f, f.namespace, f.tweakListOptions)
}
