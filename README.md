...
1. Run `make prepare-olm version=0.12.0`. Bear in mind that if there's different versions
...
```
$ make
$ docker tag quay.io/kiegroup/kogito-cloud-operator:0.12.0 quay.io/{USERNAME}/kogito-cloud-operator:0.12.0
$ docker push quay.io/{USERNAME}/kogito-cloud-operator:0.12.0
