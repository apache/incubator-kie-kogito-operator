...
```
$ make
$ docker tag quay.io/kiegroup/kogito-operator:1.42.0-snapshot quay.io/{USERNAME}/kogito-operator:1.42.0-snapshot
$ docker push quay.io/{USERNAME}/kogito-operator:1.42.0-snapshot
