...
```
$ make
$ docker tag quay.io/kiegroup/kogito-operator:1.9.2-snapshot quay.io/{USERNAME}/kogito-operator:1.9.2-snapshot
$ docker push quay.io/{USERNAME}/kogito-operator:1.9.2-snapshot
