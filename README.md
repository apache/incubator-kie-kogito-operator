...
management-console   1          quay.io/kiegroup/kogito-management-console:0.9.1 (Internal Registry)   http://management-console-kogito-1445.apps-crc.testing
```
...
1. Run `make prepare-olm version=0.9.1`. Bear in mind that if there's different versions
...
```
$ make
$ docker tag quay.io/kiegroup/kogito-cloud-operator:0.9.1 quay.io/{USERNAME}/kogito-cloud-operator:0.9.1 
$ docker push quay.io/{USERNAME}/kogito-cloud-operator:0.9.1
