...
```
$ make
$ docker tag quay.io/kiegroup/kogito-operator:1.15.1-snapshot quay.io/{USERNAME}/kogito-operator:1.15.1-snapshot
$ docker push quay.io/{USERNAME}/kogito-operator:1.15.1-snapshot
