...
1. Run `make prepare-olm version=1.0.0`. Bear in mind that if there're different versions
...
```
$ make
$ docker tag quay.io/kiegroup/kogito-cloud-operator:1.0.0 quay.io/{USERNAME}/kogito-cloud-operator:1.0.0
$ docker push quay.io/{USERNAME}/kogito-cloud-operator:1.0.0
