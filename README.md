...
```
$ make
$ docker tag quay.io/kiegroup/kogito-cloud-operator:1.2.0 quay.io/{USERNAME}/kogito-cloud-operator:1.2.0
$ docker push quay.io/{USERNAME}/kogito-cloud-operator:1.2.0
