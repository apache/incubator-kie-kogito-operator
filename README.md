...
1. Run `make prepare-olm version=0.17.0-rc1`. Bear in mind that if there're different versions
...
$ export PACKAGE_VERSION=0.17.0-rc1
...
```
$ make
$ docker tag quay.io/kiegroup/kogito-cloud-operator:0.17.0-rc1 quay.io/{USERNAME}/kogito-cloud-operator:0.17.0-rc1
$ docker push quay.io/{USERNAME}/kogito-cloud-operator:0.17.0-rc1
