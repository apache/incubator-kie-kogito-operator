...
// FinalizeKogitoRuntimeReconciler reconciles a KogitoRuntime object
type FinalizeKogitoRuntimeReconciler struct {
...
func (f *FinalizeKogitoRuntimeReconciler) SetupWithManager(mgr ctrl.Manager) error {
...
func (f *FinalizeKogitoRuntimeReconciler) Reconcile(ctx context.Context, request reconcile.Request) (result reconcile.Result, err error) {
	...
	runtimeHandler := f.RuntimeHandler(kogitoContext)
