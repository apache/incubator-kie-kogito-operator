...
func AssertFetchMustExist(t *testing.T, client *client.Client, resource runtime.Object) {
...
func AssertFetchWithKeyMustExist(t *testing.T, client *client.Client, resource runtime.Object, instance metav1.Object) {
